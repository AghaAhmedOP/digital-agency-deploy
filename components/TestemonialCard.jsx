...
const TestemonialCard = ({ image, review, avatar, name, position }) => {
  return (
    <div className="w-full px-4 lg:w-1/2">
      <Card className="!relative !mb-10 !overflow-hidden !rounded-xl !bg-white !pt-10 !px-7 shadow-testemonials sm:!px-10">
        <CardContent>
          <img
            src={image}
            alt="client Logo"
            className="text-transparent h-[25px] mb-5"
          />
          <p className="mb-8 text-base font-medium text-para sm:text-lg">
            {review}
          </p>
